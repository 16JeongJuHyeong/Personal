...
public abstract class Target_byClass : MonoBehaviour //*MonoBehaviour 클래스 상속. 그래서 Start, Update 등 기본적인 함수 사용 가능
{
    ...
    protected abstract void Moving();        // 각자 움직이는 방식이 달라서 재정의
    protected abstract void OnMouseDown();   //밑에서 각자 재정의
}